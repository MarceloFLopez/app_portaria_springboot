...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Usuario us = new Usuario(null, "Admin", "1234", true, LocalDateTime.now());
		Usuario us1 = new Usuario(null, "Teste1", "1478", true, LocalDateTime.of(2022, 10, 10, 14, 10));
		Usuario us2 = new Usuario(null, "Teste2", "7896", true, LocalDateTime.of(2021, 12, 5, 14, 10));
		Usuario us3 = new Usuario(null, "Admin", "7415", true, LocalDateTime.of(2020, 02, 10, 14, 10));
