...
class DemoApplicationTests {
	...
	public void create() {
		...
		TabOperacao op1 = new TabOperacao(null, "Coleta", LocalDateTime.now());
		TabOperacao op2= new TabOperacao(null, "Entrega", LocalDateTime.now());
		TabOperacao op = new TabOperacao(null, "Saida", LocalDateTime.now());
		or.save(op);
		or.save(op1);
		or.save(op2);
